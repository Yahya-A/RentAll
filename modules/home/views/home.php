...
<main>
  <div class="container">
    ...
    <section class="mt-5 wow fadeIn">
      ...
      <p class="m-2 text-center clearfix">
        <h3 class="mx-auto">Paling Banyak Dicari</h3>
        <p>Rekomendasi untuk anda beberapa produk yang sering dicari</p>
      </p>
      <!--Grid row-->
      <div class="row">
        ...
        <div class="card-deck">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Kamera Cannon</h5>
    ...
    <section>
      ...
      <h3 class="h3 text-center mb-5">Kemudahan yang anda dapatkan</h3>
        ...
        <div class="col-lg-6 col-md-12 px-4">
          ...
          <div class="row">
            <div class="col-1 mr-3">
              <i class="fas fa-handshake fa-2x indigo-text"></i>
            </div>
            <div class="col-10">
              <h5 class="feature-title">Transaksi Cepat</h5>
          ...
          <div class="row">
            ...
            <div class="col-10">
              <h5 class="feature-title">Cek Detail Barang</h5>
          ...
          <div class="row">
            <div class="col-1 mr-3">
              <i class="fas fa-hand-holding-usd fa-2x amber-text"></i>
            </div>
            <div class="col-10">
              <h5 class="feature-title">Pembayaran Mudah</h5>
