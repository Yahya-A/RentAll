...
-->
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/dist/font-awesome-4.7.0/css/font-awesome.min.css')?>">                <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url('assets/dist/css/bootstrap.min.css')?>">                                      <!-- Bootstrap style -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/dist/slick/slick.css')?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/dist/slick/slick-theme.css')?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/dist/css/datepicker.css')?>"/>
    <link rel="stylesheet" href="<?php echo base_url('assets/dist/css/tooplate-style.css')?>">                                   <!-- Templatemo style -->
    ...
    <body>
        ...
        <!-- load JS files -->
        <script src="<?php echo base_url('assets/dist/js/jquery-1.11.3.min.js')?>"></script>             <!-- jQuery (https://jquery.com/download/) -->
        <script src="<?php echo base_url('assets/dist/js/popper.min.js')?>"></script>                    <!-- https://popper.js.org/ -->       
        <script src="<?php echo base_url('assets/dist/js/bootstrap.min.js')?>"></script>                 <!-- https://getbootstrap.com/ -->
        <script src="<?php echo base_url('assets/dist/js/datepicker.min.js')?>"></script>                <!-- https://github.com/qodesmith/datepicker -->
        <script src="<?php echo base_url('assets/dist/js/jquery.singlePageNav.min.js')?>"></script>      <!-- Single Page Nav (https://github.com/ChrisWojcik/single-page-nav) -->
        <script src="<?php echo base_url('assets/dist/slick/slick.min.js')?>"></script>                  <!-- http://kenwheeler.github.io/slick/ -->
        <script>
